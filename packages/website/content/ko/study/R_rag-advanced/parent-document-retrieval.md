---
title: "부모 문서 검색(Parent Document Retrieval): 정밀도와 문맥을 동시에 잡는 법"
date: 2026-04-11
draft: false
tags: ["LangChain", "RAG", "부모문서검색", "아키텍처", "최적화"]
description: "검색을 위해 문서를 잘게 나누면서도, AI가 읽을 때는 충분한 전체 문맥을 유지하는 영리한 전략을 소개합니다."
author: "Henry"
categories: ["AI 엔지니어링"]
---
