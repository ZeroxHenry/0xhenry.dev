...
![클라우드 컴퓨팅과 엣지 AI의 비교](./images/client-side-ai/cloud-vs-edge.jpg)
...
![로컬 추론 프로세스의 구조적 이해](./images/client-side-ai/local-inference.jpg)
...
![엣지 AI의 3가지 핵심 이점](./images/client-side-ai/edge-ai-benefits.jpg)
...
![사용자와 클라우드를 연결하는 하이브리드 추론의 미래](./images/client-side-ai/hybrid-future.jpg)
