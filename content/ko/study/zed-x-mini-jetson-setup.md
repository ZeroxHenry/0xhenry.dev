...
![실패와 최종 성공의 1달 타임라인](/images/zed-timeline.svg)
...
![연결 토폴로지: 어댑터 경로 실패, 네이티브 경로 성공](/images/zed-connection-diagram.svg)
...
![하드웨어부터 애플리케이션까지 소프트웨어 아키텍처](/images/zed-software-stack.svg)
