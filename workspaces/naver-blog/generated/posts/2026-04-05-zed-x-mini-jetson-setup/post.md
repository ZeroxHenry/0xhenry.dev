# ZED X Mini + Jetson Orin NX: 30일간의 삽질 기록
...
![디버깅 여정 — 혼돈에서 성공까지](/Users/chobyeongjun/0xhenry.dev/packages/website/public/images/study/zed/journey-desk.jpg)
...
![전체 신호 경로: ZED X Mini → GMSL2 캡처 카드 → Jetson Orin NX](/Users/chobyeongjun/0xhenry.dev/packages/website/public/images/study/zed/signal-path.jpeg)

실제 하드웨어 연결하면 이렇게 생겼다 — GMSL2 캡처 카드가 카메라랑 Jetson 보드 사이에 FFC 리본 케이블로 연결돼있다:

![실제 하드웨어: Jetson Orin NX와 GMSL2 캡처 카드의 FFC 리본 연결](/Users/chobyeongjun/0xhenry.dev/packages/website/public/images/study/zed/capture-card-real.jpeg)

---

## 1-2주차: 어댑터의 함정

![몇 주간의 실패](/Users/chobyeongjun/0xhenry.dev/packages/website/public/images/study/zed/failure-desk.jpg)
...
![15핀(안 됨) vs 22핀(됨) CSI 커넥터 — 비슷하게 생겼지만 완전히 다른 신호를 보낸다](/Users/chobyeongjun/0xhenry.dev/packages/website/public/images/study/zed/csi-connector-comparison.jpeg)
...
![동작하는 뎁스맵 — 30일 만에 드디어 본 화면](/Users/chobyeongjun/0xhenry.dev/packages/website/public/images/study/zed/depth-success.jpg)

---

## 전체 소프트웨어 스택

![하드웨어부터 애플리케이션까지 5개 레이어](/Users/chobyeongjun/0xhenry.dev/packages/website/public/images/study/zed/stack-visual.jpg)
