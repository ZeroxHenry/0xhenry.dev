...
content_paths = [
    ...
    "/Users/chobyeongjun/0xhenry.dev/packages/website/content/en"
]
            ...
            for file in files:
                if file.endswith(".md") or file.endswith(".markdown"):
                    ...
                    if not check_images(full_path):
                        ...
                        no_image_files.append(f"en/{rel_path}")

if no_image_files:
    print("### [사진 없는 영어 기사 목록]")
    for f in no_image_files:
        print(f"- {f}")
else:
    print("No image-less English files found.")
