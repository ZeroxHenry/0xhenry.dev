---
title: "MCP의 보안 구멍: Tool Poisoning 공격이란 무엇이고, 어떻게 막는가"
date: 2026-04-13
draft: false
tags: ["MCP", "AI보안", "Tool Poisoning", "AI에이전트", "사이버보안"]
description: "AI의 USB-C라 불리는 MCP(Model Context Protocol)가 새로운 공격 표면을 만들고 있습니다. 아무도 아직 한국어로 설명하지 않은 'Tool Poisoning' 공격 시나리오와 실제 방어 전략을 파헤칩니다."
author: "Henry"
categories: ["AI 보안"]
---
