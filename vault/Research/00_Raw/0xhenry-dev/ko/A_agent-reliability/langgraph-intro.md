---
title: "LangGraph: 복잡한 에이전트 워크플로우 오케스트레이션"
date: 2026-04-12
draft: false
tags: ["LangGraph", "LangChain", "상태머신", "AI에이전트", "그래프아키텍처"]
description: "단일 루프 에이전트가 실패하는 이유와, LangGraph를 사용하여 안정적이고 상태 유지가 가능한 에이전틱 워크플로우를 구축하는 법을 알아봅니다."
author: "Henry"
categories: ["AI 엔지니어링"]
---
