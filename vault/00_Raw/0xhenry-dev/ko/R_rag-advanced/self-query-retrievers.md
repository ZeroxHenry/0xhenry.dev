---
title: "셀프 쿼리 검색(Self-Querying Retrievers): AI가 스스로 필터를 적용하는 법"
date: 2026-04-11
draft: false
tags: ["LangChain", "RAG", "셀프쿼리", "메타데이터", "최적화"]
description: "단순 유사도 검색을 넘어, AI가 날짜, 카테고리, 작성자 등의 메타데이터 필터를 스스로 적용하게 가르치는 방법을 알아봅니다."
author: "Henry"
categories: ["AI 엔지니어링"]
---
