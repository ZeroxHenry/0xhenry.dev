---
title: "LLM이 '멍청해지는' 이유 — Context Rot 현상 완전 해부"
date: 2026-04-13
draft: false
tags: ["Context Engineering", "Context Rot", "LLM", "Lost in the Middle", "AI아키텍처", "프로덕션AI"]
description: "대화가 길어질수록 AI가 앞서 한 말을 무시하거나 엉뚱한 답을 한다면, 프롬프트 문제가 아닙니다. Context Rot — AI의 작업 기억이 썩어가는 현상을 완전히 해부하고, 실전 수치와 함께 해결책을 제시합니다."
author: "Henry"
categories: ["AI 엔지니어링"]
---
